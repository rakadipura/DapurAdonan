  ...
  const sampleProducts: Prisma.ProductCreateInput[] = [
    {
      ...
      imageUrl: "/images/ronde-coklat.svg",
      dailyStock: 30,
    ...
    },
    {
      ...
      basePrice: 27000,
      category: { connect: { id: categories[0].id } },
      imageUrl: "/images/ronde-keju.svg",
      dailyStock: 25,
      allergens: ["gluten", "dairy"],
      tags: [],
    },
    {
      ...
      imageUrl: "/images/kue-kering-pandan.svg",
      dailyStock: 50,
    ...
    },
    {
      ...
      basePrice: 18000,
      category: { connect: { id: categories[1].id } },
      imageUrl: "/images/kue-kering-sesame.svg",
      dailyStock: 50,
    ...
    },
    {
      ...
      basePrice: 22000,
      category: { connect: { id: categories[1].id } },
      imageUrl: "/images/kue-kering-talam.svg",
      dailyStock: 30,
      allergens: ["gluten", "dairy", "eggs"],
      tags: [],
    },
    {
      ...
      imageUrl: "/images/kue-lempeng.svg",
      dailyStock: 40,
      allergens: ["gluten", "dairy"],
      tags: [],
    },
    {
      ...
      imageUrl: "/images/roti-croissant.svg",
      dailyStock: 20,
      allergens: ["gluten", "dairy", "eggs"],
      tags: ["best-seller"],
    },
    {
      ...
      basePrice: 30000,
      category: { connect: { id: categories[3].id } },
      imageUrl: "/images/roti-bolu-coklat.svg",
      dailyStock: 15,
      allergens: ["gluten", "dairy", "eggs"],
      tags: [],
    },
    {
      ...
      imageUrl: "/images/es-teh-manis.svg",
      dailyStock: null,
      allergens: [],
      tags: [],
    },
    {
      ...
      basePrice: 15000,
      category: { connect: { id: categories[4].id } },
      imageUrl: "/images/es-kopi-susu.svg",
      dailyStock: null,
    ...
    // Custom cake product
    {
      ...
      imageUrl: "/images/kue-custom.svg",
      dailyStock: 5,
      leadTimeDays: 3,
      isCustomCake: true,
